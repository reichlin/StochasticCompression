...
class Net(nn.Module):
    ...
    def __init__(self, min_accuracy, colors, depth, model_size, n, L, compression_sampling_function, adaptive_compression_sampling, k_sampling_policy,
                 exploration_epsilon, a_size, a_depth, a_act, decoder_type):
